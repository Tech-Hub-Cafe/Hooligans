...
export async function PUT(request: Request) {
  ...
  try {
    ...
    const {
      ...
      saturday_hours,
      sunday_hours,
      monday_ordering_hours,
      tuesday_ordering_hours,
      wednesday_ordering_hours,
      thursday_ordering_hours,
      friday_ordering_hours,
      saturday_ordering_hours,
      sunday_ordering_hours,
      facebook_url,
      instagram_url,
      twitter_url,
      tiktok_url,
